...
# Load Soh ASV table
load("combined_data/data/03_analysis_Soh/noChimeras_ASV_table.RData")
noChimeras_ASV_table_soh <- noChimeras_ASV_table
rm(noChimeras_ASV_table)


# Load Bikrim ASV table
load("combined_data/data/05_fullLength_analysis_Bikrim/noChimeras_ASV_table.RData")
...
load("combined_data/data/05_2011_analysis_Alessandro/noChimeras_ASV_table.RData")
noChimeras_ASV_table_alessandro_2011 <- noChimeras_ASV_table
rm(noChimeras_ASV_table)


## Load 2017 Illumina run 
load("combined_data/data/06_2017_analysis_Alessandro/noChimeras_ASV_table.RData")
