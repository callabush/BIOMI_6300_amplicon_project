...
species_df %>%
  # Warning: Its important to have one sample per x value,
  # Otherwise, it will take the sum between multiple samples
  ggplot(aes(x = names, y = Abundance, fill = Species)) +
  #facet_grid(.~gut_section) + 
  geom_bar(stat = "identity", color = "black") +
...
species_df %>%
  ...
  geom_jitter() +
  theme_bw() +
  labs(title = "Bacteroidota species Abundance") +
  scale_color_manual(values = gut_section_colors) +
  scale_fill_manual(values = gut_section_colors) 
...
species_df %>%
  ...
  geom_jitter() +
  theme_bw() +
  labs(title = "Firmicutes species Abundance") +
  scale_color_manual(values = gut_section_colors) +
  scale_fill_manual(values = gut_section_colors)
...
species_df %>%
  ...
  geom_jitter() +
  theme_bw() +
  labs(title = "Proteobacteria species Abundance") +
  scale_color_manual(values = gut_section_colors) +
  scale_fill_manual(values = gut_section_colors)
