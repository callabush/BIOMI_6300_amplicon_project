...
# Check tax of ASV 347, 527, 542, 609, 1000, 1087
control_taxa <-
controlASV_physeq %>%
 tax_table() %>%
 data.frame()
...
# Would only like to keep ASV 347, 527, 542, everything else is trash
controlASVs_toREMOVE <- dplyr::setdiff(control_ASVs$ASV, c("ASV_347", "ASV_527",
                                                           "ASV_542"))
# double check 
...
noControlsChlorosMitos_physeq <- 
  noChlorosMitos_physeq %>%
  # Actually remove the control ASVs (except ASV 347, 527, 542)
